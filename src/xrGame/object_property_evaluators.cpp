...
//////////////////////////////////////////////////////////////////////////
// CObjectPropertyEvaluatorPump --#SM+#--
//////////////////////////////////////////////////////////////////////////

CObjectPropertyEvaluatorPump::CObjectPropertyEvaluatorPump(CWeapon* item, CAI_Stalker* owner) : inherited(item, owner) {}

CObjectPropertyEvaluatorPump::_value_type CObjectPropertyEvaluatorPump::evaluate()
{
    return m_item->Need2Pump();
}
