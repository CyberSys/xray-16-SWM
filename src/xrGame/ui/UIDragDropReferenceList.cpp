...
void CUIDragDropReferenceList::LoadItemTexture(LPCSTR section, Ivector2 cell_pos)
{
    ...
    xr_string sIconsTexture = READ_IF_EXISTS(pSettings, r_string, section, "inv_texture", INV_TEXTURE_DEF); //--#SM+#--
    ref->SetShader(InventoryUtilities::GetEquipmentIconsShader(sIconsTexture));
