...
class CSE_ALifeItemWeapon : public CSE_ALifeItem //--#SM+#--
{
    using inherited = CSE_ALifeItem;
...
class CSE_ALifeItemWeaponMagazined : public CSE_ALifeItemWeapon //--#SM+#--
{
...
class CSE_ALifeItemWeaponMagazinedWGL : public CSE_ALifeItemWeaponMagazined //--#SM+#--
{
...
class CSE_ALifeItemWeaponShotGun : public CSE_ALifeItemWeaponMagazined //--#SM+#--
{
    using inherited = CSE_ALifeItemWeaponMagazined;
