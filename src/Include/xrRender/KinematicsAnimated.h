...
public:
    ...
    virtual void LL_ClearAdditionalTransform(u16 bone_id, KinematicsABT::SourceID source_id) = 0; //--#SM+#--
    virtual void LL_SetAdditionalTransformCurIntervalFactor(float fCurIntFactor) = 0; //--#SM+#--
