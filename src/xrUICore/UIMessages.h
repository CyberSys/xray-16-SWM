...
enum EUIMessages
{
	...
	//--#SM+# Begin--
    INVENTORY_ATTACH_MAGAZINE_ADDON,
    INVENTORY_DETACH_MAGAZINE_ADDON,

    INVENTORY_ATTACH_SPECIAL_1_ADDON,
    INVENTORY_DETACH_SPECIAL_1_ADDON,

    INVENTORY_ATTACH_SPECIAL_2_ADDON,
    INVENTORY_DETACH_SPECIAL_2_ADDON,

    INVENTORY_ATTACH_SPECIAL_3_ADDON,
    INVENTORY_DETACH_SPECIAL_3_ADDON,

    INVENTORY_ATTACH_SPECIAL_4_ADDON,
    INVENTORY_DETACH_SPECIAL_4_ADDON,

    INVENTORY_ATTACH_SPECIAL_5_ADDON,
    INVENTORY_DETACH_SPECIAL_5_ADDON,

    INVENTORY_ATTACH_SPECIAL_6_ADDON,
    INVENTORY_DETACH_SPECIAL_6_ADDON,
    //--#SM+# End--

    INVENTORY_RELOAD_MAGAZINE,
    INVENTORY_LOAD_MAGAZINE_FAST, //--#SM+#--	
    INVENTORY_UNLOAD_MAGAZINE_MAIN, //--#SM+#--
    INVENTORY_UNLOAD_MAGAZINE_SECOND, //--#SM+#--
